...
import panelStyles from '@/shared/styles/panel.css?inline'
...
function mountContentUi(): void {
  ...
  initializePageLanguage()
  initializeExampleSpeech()
  // Only this document has a page reading to release when an example or a
  // pronunciation claims the single audio session.
  setExampleSpeechPreemption(disposeReading)
  ...
  window.addEventListener(
    ...
    () => {
      ...
      destroyPageLanguage()
      destroyExampleSpeech()
      setExampleSpeechPreemption(null)
      destroyClickToListen()
      destroyModifierSelection()
      destroyHighlightOverlay()
